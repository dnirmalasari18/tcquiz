                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children @yield('quiz') dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-pencil"></i><a href="/admin/create-quiz">Create a Quiz</a></li>
                            <li><i class="menu-icon fa fa-list-ul"></i><a href="/admin/quiz-list">List of Quizzes</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
