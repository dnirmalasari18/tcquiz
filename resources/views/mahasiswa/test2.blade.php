...
<div class="col-md-9">
    <div class="card">
        <div class="card-header">
            ...
            <label class="switch switch-3d switch-danger mr-3" style="float: right; margin-bottom: 0;"><input type="checkbox" class="switch-input" checked="true"> <span class="switch-label"></span> <span class="switch-handle"></span></label>
        </div>
        <div class="card-body">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row" style="font-size: 10px; margin-bottom: 15px;">
                ...
                <div class="col">
                    <section class="card" style="width: 30px; height: 30px; line-height: 28px;">
                        <div class="card-body text-secondary" style="padding:0;text-align: center; background-color: #e87c86; color: white !important;">14</div>
                    </section>
                </div>
                <div class="col">
                    <section class="card" style="width: 30px; height: 30px; line-height: 28px;">
